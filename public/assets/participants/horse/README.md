# Horse Brown V1 runtime atlas

- Atlas image: `horse-brown-v1.png`
- Frame metadata: `horse-brown-v1.json`
- Grid: 5 columns × 4 rows
- Cell size: 320 × 320 px
- Directions: `frontRight`, `right`, `backRight`, `back`
- Animations: `idle` (1 frame), `run` (4 frames)
